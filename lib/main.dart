...
import 'package:clean_architecture_weather/weather/data/repository/weather_repository.dart';
...
import 'package:clean_architecture_weather/weather/domain/usecases/get_weather_by_city.dart';
import 'package:flutter/material.dart';

Future<void> main() async {
  BaseRemoteDataSource baseRemoteDataSource = RemoteDataSource();
  BaseWeatherRepository baseWeatherRepository = WeatherRepository(baseRemoteDataSource);
  Weather weather = await GetWeatherByCityName(baseWeatherRepository).execute("Syria");
  print(weather);
  runApp(const MyApp());
}
